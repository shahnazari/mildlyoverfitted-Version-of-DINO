...
def main():
    ...
    parser.add_argument("-b", "--batch-size", type=int, default=55)
    parser.add_argument(
    ...
    parser.add_argument("-c", "--n-crops", type=int, default=2)
    ...
    path_dataset_train = pathlib.Path("data/train/")
    path_dataset_val = pathlib.Path("data/val/")
